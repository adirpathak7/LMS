...
const Register = () => {
    ...
    const handelRegisterForm = (e) => {
        e.preventDefault();
        const { firstName, lastName, email, contact, area, country, state, city, zipcode, profilePicture, password } = data;
        ...
        if (!password.match(validPassword)) {
            document.getElementById("error-password").innerHTML = `Weak Password please include bellow inormation's: <br/>
            Password must be contains at least 8 digit.<br/>
            At least one lowercase alphabet<br/>
            At least one uppercase alphabet<br/>
        ...
        axios.post('http://localhost:8100/LMS/api/register', data).then(response => {
                                    ...
                                    <form onSubmit={handelRegisterForm}>
                                        <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                            <div className="md:col-span-2">
                                                ...
                                                <input type="text" name="firstName" id="firstName" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder='Enter First Name'
                                            ...
                                            <div className="md:col-span-2">
                                                ...
                                                <input type="text" name="lastName" id="lastName" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder='Enter Last Name'
                                                    onChange={handelChange}
                                                    value={data.lastName}
                                                />
